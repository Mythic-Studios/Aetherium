...
public class ChargedHoeItem extends HoeItem implements ChargedTool, Rechargeable {
    private final ChargedToolMaterial material;

    public ChargedHoeItem(ChargedToolMaterial material, float attackDamageBaseline, float attackSpeedBaseline,
