...
public class ChargedShovelItem extends ShovelItem implements ChargedTool, Rechargeable {
    private final ChargedToolMaterial material;

    public ChargedShovelItem(ChargedToolMaterial material, float attackDamageBaseline, float attackSpeedBaseline,
                             Properties properties) {
        super(material.vanillaMaterial(), attackDamageBaseline, attackSpeedBaseline,
                properties.component(ModDataComponents.TOOL_CHARGE, 0));
